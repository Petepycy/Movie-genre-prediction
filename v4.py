...
# Train the model
model.fit(padded_sequences_train, y_train, batch_size=128, epochs=30, validation_data=(padded_sequences_test, y_test), callbacks=[early_stopping, lr_schedule])
...
model.save('overview_model_updated_v4.keras')
